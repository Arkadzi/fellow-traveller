...
public class SubscribeUseCase extends UseCase<String> {

    private final Repository repository;
    private String pointId;

    @Inject
    public SubscribeUseCase(SubscribeOn subscribeOn, ObserveOn observeOn, Repository repository) {
    ...
    protected Observable<String> getUseCaseObservable() {
        return repository.subscribe(pointId);
    }
}
